...
export default function Services({ sectionTitle, services }: Props) {
  return (
    <section
      id="services"
      className="relative py-24 bg-[#F5F5F0] z-30 md:z-auto"
    >
      <div className="max-w-[1400px] mx-auto px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {services.map((service, index) => {
            ...
            const imageOrderDesktop = imageOnLeftDesktop
              ? "md:order-1"
              : "md:order-2";
            const textOrderMobile = imageOnLeftMobile ? "order-2" : "order-1";
            const textOrderDesktop = imageOnLeftDesktop
              ? "md:order-2"
              : "md:order-1";
            ...
            return (
              ...
              >
                <div
                  className={`relative w-1/2 flex-shrink-0 min-h-[200px] ${imageOrderMobile} ${imageOrderDesktop}`}
                >
                  <Image
                    src={service.image}
                    alt={service.title}
                ...
                <div
                  className={`w-1/2 flex flex-col justify-center p-4 sm:p-6 bg-[#77736D] ${textOrderMobile} ${textOrderDesktop}`}
                >
                  {Icon && (
