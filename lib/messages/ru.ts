...
export const ru: Messages = {
  ...
  about: {
    ...
    payButton: "Оплатить консультацию (Stripe)",
  ...
  contact: {
    ...
    emailSuccess:
      "Заявка отправлена на почту. Мы свяжемся с вами в удобный способ.",
    emailError:
      "Не удалось отправить заявку. Попробуйте позже или свяжитесь через Telegram или оплату консультации.",
    serviceOptions: [
  ...
  footer: {
    ...
    socialText:
      "Facebook (группа) и Telegram — выберите удобный канал.",
    paymentTitle: "Оплата",
    payLink: "Оплатить консультацию (Stripe)",
    payNote:
      "Оплата подтверждает заказ информационно-консультационной услуги.",
